 ...
 * @since 3.5.0
 */
public class ScasOAuthAction extends AbstractAction {
    
    private static final Logger logger = LoggerFactory.getLogger(ScasOAuthAction.class);
    ...
    protected Event doExecute(RequestContext context) throws Exception {
    	org.jasig.cas.web.support.CasArgumentExtractor a = null;
        ...
        if (StringUtils.isNotBlank(providerType)) {
            ...
            // create credentials
            String s = credential.getToken();
            String v = credential.getVerifier();
            String p = credential.getProviderType();
            ...
            try {
                ...
                try {
					accountService.createSocialConnection(credentials);
				} catch (Exception e) {
					e.printStackTrace();
				}
                return success();
